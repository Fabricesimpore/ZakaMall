    ...
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center p-6 text-center border border-red-200 rounded-lg bg-red-50">
          ...
          <h3 className="text-lg font-medium text-red-900 mb-2">Document Loading Error</h3>
          <p className="text-red-700 mb-4 text-sm max-w-md">
            Unable to display the document. This could be due to a network issue or the document
            might be corrupted.
          </p>
