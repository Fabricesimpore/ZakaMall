          ...
          <CardContent className="prose prose-gray max-w-none">
            <section className="mb-8">
              ...
              <p className="text-zaka-gray leading-relaxed mb-4">
                ZakaMall ("nous", "notre" ou "nos") s'engage à protéger votre vie privée. Cette politique de confidentialité explique comment nous collectons, utilisons, divulguons et protégeons vos informations lorsque vous utilisez notre marketplace en ligne.
              </p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-zaka-dark mb-4">2. Informations que nous collectons</h2>
              
              <h3 className="text-xl font-medium text-zaka-dark mb-3">2.1 Informations personnelles</h3>
              ...
              <h3 className="text-xl font-medium text-zaka-dark mb-3">2.2 Informations d'utilisation</h3>
              <ul className="list-disc list-inside text-zaka-gray space-y-2 mb-4">
              ...
              <h3 className="text-xl font-medium text-zaka-dark mb-3">2.3 Informations techniques</h3>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-zaka-dark mb-4">3. Comment nous utilisons vos informations</h2>
              <ul className="list-disc list-inside text-zaka-gray space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-zaka-dark mb-4">4. Partage de vos informations</h2>
              <p className="text-zaka-gray leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-zaka-dark mb-4">5. Sécurité des données</h2>
              <p className="text-zaka-gray leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-zaka-gray leading-relaxed mt-4">
                Pour exercer ces droits, contactez-nous à : <a href="mailto:privacy@zakamall.com" className="text-zaka-orange hover:underline">privacy@zakamall.com</a>
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-zaka-dark mb-4">7. Cookies et technologies similaires</h2>
              <p className="text-zaka-gray leading-relaxed mb-4">
              ...
              <ul className="list-disc list-inside text-zaka-gray space-y-2">
                ...
                <li><strong>Cookies marketing :</strong> Personnalisent la publicité (avec consentement)</li>
              </ul>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-zaka-dark mb-4">8. Conservation des données</h2>
              <p className="text-zaka-gray leading-relaxed">
                Nous conservons vos données personnelles aussi longtemps que nécessaire pour fournir nos services et respecter nos obligations légales. Les critères de conservation incluent :
              </p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-zaka-dark mb-4">9. Transferts internationaux</h2>
              <p className="text-zaka-gray leading-relaxed">
                Vos données peuvent être transférées et stockées dans des pays autres que le Burkina Faso. Nous nous assurons que tous les transferts respectent les standards de protection appropriés.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-zaka-dark mb-4">10. Protection des mineurs</h2>
              <p className="text-zaka-gray leading-relaxed">
                Nos services ne sont pas destinés aux enfants de moins de 16 ans. Nous ne collectons pas intentionnellement de données personnelles d'enfants de moins de 16 ans.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-zaka-dark mb-4">11. Modifications de cette politique</h2>
              <p className="text-zaka-gray leading-relaxed">
                Nous pouvons mettre à jour cette politique de confidentialité. Les modifications importantes seront communiquées par e-mail ou via une notification sur notre site.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-zaka-light p-4 rounded-lg">
                ...
                <p className="text-zaka-gray">Email : <a href="mailto:privacy@zakamall.com" className="text-zaka-orange hover:underline">privacy@zakamall.com</a></p>
