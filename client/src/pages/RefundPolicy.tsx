        ...
        <Card>
          ...
          <CardContent className="prose prose-gray max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-zaka-dark mb-4">1. Aperçu de la politique</h2>
              <p className="text-zaka-gray leading-relaxed mb-4">
                Chez ZakaMall, votre satisfaction est notre priorité. Cette politique explique vos droits concernant les retours, échanges et remboursements de vos achats sur notre marketplace.
              </p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-zaka-dark mb-4">2. Conditions de retour</h2>
              
              <h3 className="text-xl font-medium text-zaka-dark mb-3">2.1 Produits éligibles au retour</h3>
              ...
              <h3 className="text-xl font-medium text-zaka-dark mb-3">2.2 État requis du produit</h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-zaka-gray">Connectez-vous à votre compte → "Mes Commandes" → "Demander un retour"</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-zaka-gray">Choisissez le motif de retour et ajoutez des photos si nécessaire</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-zaka-gray">Nous vous enverrons l'adresse de retour et l'étiquette prépayée (si applicable)</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-zaka-gray">Emballez soigneusement et expédiez via le transporteur indiqué</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-zaka-gray">Suivez votre retour et recevez votre remboursement après inspection</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-zaka-dark mb-4">5. Délais de remboursement</h2>
              ...
              <p className="text-sm text-zaka-gray mt-4">
                <i className="fas fa-info-circle text-zaka-orange mr-2"></i>
                Les délais commencent après réception et validation de votre retour par notre équipe.
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-zaka-dark mb-4">8. Litiges et réclamations</h2>
              <p className="text-zaka-gray leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-zaka-dark mb-4">9. Conseils pour éviter les retours</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
            ...
            <div className="bg-zaka-orange bg-opacity-10 border border-zaka-orange p-6 rounded-lg text-center">
              ...
              <p className="text-zaka-gray text-sm">
                Cette politique peut être modifiée. Les changements importants seront communiqués à l'avance.
              </p>
            </div>
          </CardContent>
        </Card>
