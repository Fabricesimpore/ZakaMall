          ...
          <CardContent>
            <div className="bg-blue-50 p-4 rounded-lg">
              <p className="text-sm text-blue-700">
                ...
                Interface de test pour valider les paiements Orange Money, Moov Money et paiement à la livraison
              </p>
            </div>
          </CardContent>
        </Card>
            ...
            <Card className="mb-4">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Commande <code className="bg-gray-100 px-2 py-1 rounded">{testOrderId}</code> prête pour le paiement
                </p>
              </CardContent>
            </Card>
        ...
        {step === 'success' && (
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-lg font-semibold mb-2 text-green-800">Test de paiement réussi!</h3>
              <p className="text-gray-600 mb-6">
                Le système de paiement ZakaMall fonctionne correctement.
              </p>
              <Button 
                onClick={resetTest}
                className="bg-zaka-blue hover:bg-zaka-blue"
              >
