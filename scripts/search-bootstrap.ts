...
async function bootstrap() {
  ...
  try {
    ...
    await index.updateSettings({
      ...
      stopWords: ["the", "a", "an", "and", "or", "but", "in", "on", "at", "to", "for", "of", "with", "by", "le", "la", "les", "un", "une", "des", "et", "ou", "dans", "sur", "pour", "avec", "par"],
    ...
    console.log("🔍 Filterable attributes: vendor_id, categories, brand, in_stock, currency, price_cents");
