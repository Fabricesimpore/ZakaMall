...
const { validateDatabaseSchema, autoFixMissingTables } = require('../dist/server/database/schema-validator.js');
const { ensureDatabaseUpToDate, runPendingMigrations } = require('../dist/server/database/migration-manager.js');
